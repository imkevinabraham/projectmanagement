...
<table cellpadding="0" border="0"
    ...
    <tr>
        <td width="100%" align="center">
            ...
            <table cellpadding="0" border="0"
                   style="line-height: 1.2em; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; border-spacing: 0; font-size: 100%; border: 0; margin: 0; padding: 0; border-spacing: 0; background-color: #fff; border: 1px solid #e8e9eb; width: 580px; min-width: 370px;border-radius: 5px; margin-top:40px;"
                   cellspacing="0">
                <tbody>
                <tr>
                    <td>
                                    ...
                                    <table cellpadding="0" border="0"
                                        ...
                                        <tr valign="top">
                                            <td style="max-width: 420px; min-width: 440px; padding: 0; color: #585a5e; line-height: 24px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; border-spacing: 0; text-align: left;">
                                                <p style="line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; color: #81898F; text-shadow: none; margin: 0; padding:10px 30px 0; ">
                                                    <span style="font-weight: 500;color: #576269;font-size:18px;">Hello,</span><br>
